...
INTEGER, PARAMETER :: length_step_z_2 = 384
...
REAL (DP), PARAMETER :: dx2_ini = (1.0D0/256.0D0)
...
REAL (DP), PARAMETER :: total_time = 1.0D0
...
INTEGER, PARAMETER :: boundary_flag(4) = (/1,1,1,1/)
...
INTEGER, PARAMETER :: testmodel_flag = 2
