...
INTEGER, PARAMETER :: length_step_r_2 = 100
...
INTEGER, PARAMETER :: length_step_z_2 = 300
...
REAL (DP), PARAMETER :: dx2_ini = (0.5D0/100.0D0)
...
REAL (DP), PARAMETER :: total_time = 7.5D0
...
INTEGER, PARAMETER :: boundary_flag(4) = (/0,0,1,1/)
...
INTEGER, PARAMETER :: testmodel_flag = 5
