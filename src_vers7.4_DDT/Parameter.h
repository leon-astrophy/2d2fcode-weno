...
INTEGER, PARAMETER :: length_step_r_1 = 600
INTEGER, PARAMETER :: length_step_r_2 = 600
...
INTEGER, PARAMETER :: length_step_z_1 = 600
INTEGER, PARAMETER :: length_step_z_2 = 600
...
REAL (DP), PARAMETER :: dx1_ini = (3500.0D0/600.0D0)!10.0D0
REAL (DP), PARAMETER :: dx2_ini = (3500.0D0/600.0D0)!10.0D0
...
REAL (DP), PARAMETER :: total_time = 1.0D6
...
REAL (DP) :: rho1_c = 3.0E0_DP * 1.6190E-10_DP !1.0E-13_DP				

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Initial central density of normal matter
!
! Hint1: One sets rho2_c = 7.11D-11 for 1.05 solar mass WD (Ye = 0.5)
! Hint2: One sets rho2_c = 4.83D-9 for 1.37 solar mass WD (Ye = 0.5)
...
REAL (DP) :: rhofac_1 = 1.0E-5_DP
REAL (DP) :: rho1_a = 1.0E-13_DP
...
REAL (DP) :: rhofac_2 = 1.0E-5_DP
REAL (DP) :: rho2_a = 1.0E-13_DP
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! Flag for fixing the atmospheric density
!
! 1 = Switch on for adjusting the atmospheric density

INTEGER :: fixrhodm_flag = 0
INTEGER :: fixrhonm_flag = 1

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! Flag for tracking if the grid size needs to be enlarged
! to accomodate the expanding star
!
! 1 = Switch on moving grid flag if necessary

INTEGER, PARAMETER :: found_movinggriddm_flag = 0
INTEGER, PARAMETER :: found_movinggridnm_flag = 1

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Flag for allowing the grid size to change
! can be switched on later by the coding
!
! 1 = The length_step_r_part and length_step_z_part will be time-dependent
...
INTEGER, PARAMETER :: initmodel_flag = 1
...
INTEGER, PARAMETER :: boundary_flag(4) = (/1,2,1,2/)
...
INTEGER, PARAMETER :: checkrho_flag = 1
...
INTEGER, PARAMETER :: testmodel_flag = 1
...
! Flags for the Polytropic EOS
! 1 = use polytropic EOS
INTEGER, PARAMETER :: polyeosnm_flag = 0
...
INTEGER, PARAMETER ::  deflevelset_flag = 1
...
INTEGER, PARAMETER :: detlevelset_flag = 1
...
INTEGER, PARAMETER :: tracer_flag = 1
...
REAL (DP) :: output_profiletime = 2.5D4
...
REAL (DP) :: output_flametime = 2.5D4                      	
REAL (DP) :: output_flametime_last = 0.0D0

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! 
! Physical time interval for each SGS turb profile

REAL (DP) :: output_turbtime = 2.5D4
REAL (DP) :: output_turbtime_last = 0.0D0

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! 
! Physical time interval for each isotope profiles

REAL (DP) :: output_Helmtime = 2.5D4				
REAL (DP) :: output_Helmtime_last = 0.0D0
...
REAL (DP) :: output_backuptime = 0.5D0
REAL (DP) :: output_backuptime_last = 0.0D0
