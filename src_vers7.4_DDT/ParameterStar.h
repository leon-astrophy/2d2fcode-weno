...
INTEGER, PARAMETER :: length_step_r_1 = 200
...
INTEGER, PARAMETER :: length_step_z_1 = 200
...
REAL (DP), PARAMETER :: dx1_ini = 10.0D0
REAL (DP), PARAMETER :: dx2_ini = 10.0D0
...
INTEGER, PARAMETER :: mapping_flag = 1
...
! For NM
INTEGER, PARAMETER :: checkstepnm_flag = 1
...
REAL (DP) :: output_profiletime = 1.0D5
...
REAL (DP), PARAMETER :: output_flametime = 1.0D5                       	
...
REAL (DP), PARAMETER :: output_turbtime = 1.0D5
...
REAL (DP), PARAMETER :: output_Helmtime = 1.0D5				
...
REAL (DP), PARAMETER :: output_PPTtime = 2.5D3				
